macro(enable_cppcheck CPPCHECK_OPTIONS)
  ...
  if(CPPCHECK)
    ...
    if(${ProjectOptions_WARNINGS_AS_ERRORS})
      ...
      log_warn("cppcheck requested but executable not found")
    endif()
  endif()
endmacro()
...
macro(enable_clang_tidy)
  ...
  if(CLANGTIDY)
    ...
    log_warn("clang-tidy requested but executable not found")
    endif()
  endif()
endmacro()
...
macro(enable_include_what_you_use)
  ...
  if(INCLUDE_WHAT_YOU_USE)
    ...
    if(${ProjectOptions_WARNINGS_AS_ERRORS})
      ...
      log_warn("include-what-you-use requested but executable not found")
    endif()
  endif()
endmacro()
